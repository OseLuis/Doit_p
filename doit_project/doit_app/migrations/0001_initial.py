    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detallesAdicionales', models.CharField(default='Sin detalles', max_length=255)),
                ('Ciudad', models.CharField(default='Sin ciudad', max_length=255)),
                ('Departamento', models.CharField(default='Sin departamento', max_length=255)),
                ('pais', models.CharField(default='Sin país', max_length=255)),
                ('metodoDePago', models.CharField(default='Sin método de pago', max_length=255)),
                ...
                ('metodoDePago', models.CharField(choices=[('Efectivo', 'Efectivo'), ('Tarjeta', 'Tarjeta'), ('Transferencia', 'Transferencia')], max_length=50)),
                ('ciudad', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='doit_app.ciudad')),
                ('idUsuario', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('pais', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='doit_app.pais')),
                ('idServicios', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='doit_app.servicios')),
            ],
            options={
